...
Damien gives you the core functionality without that mess.
...
- Custom `damien` MCP server (inside container) provides scheduling tools
...
**Damien** - A reference to Clawdbot (now OpenClaw).
